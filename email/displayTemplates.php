    ...
    <div class="block ">
        ...
        <table class="form">
          ...
          <tr>
            <td class="col1">
              <label>
         			Name of a New Template:
              </label>
            </td>
            <td class="col2">
         			<input type="text" placeholder="Enter only for creating new template" name="name" />
            </td>            
          </tr>
					<tr>
						<td><button class="btn btn-orange"
						name="creative_new_template" value="creative_new_template">Create a Template</button></td>
						<td><button class="btn btn-orange"
						name="update_template" value="update_template">Update a Template</button></td>
					</tr>
        </table>
      </form>
    </div>
